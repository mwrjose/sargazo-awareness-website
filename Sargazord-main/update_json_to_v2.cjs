...
function updateFile(filePath) {
  ...
  data.metrics = {
    "r2": 0.901,          // Mapeado a AUC-ROC en la UI
    "r2_adj": 0.3902,     // Mapeado a Pseudo R2 (McFadden)
    "n_obs": 529,         // Observaciones diarias
    "mae_modelo": -161.58, // Log-Likelihood
    "mejora_pct": 21.6,   // Mantener informativa
    "f_stat": 6.699e-42   // LLR p-value
  };
